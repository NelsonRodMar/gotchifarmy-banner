...
contract GotchiFarmyBannerV2 is ERC1155Upgradeable, ERC2981Upgradeable, OwnableUpgradeable, PausableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    // @notice The function to set the version of the contract
    function changeVersion(uint256 _version) external onlyOwner {
        version = _version;
    }
